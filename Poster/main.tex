    ...
    \block{}{
        ...
        \begin{minipage}[c]{\linewidth}
            ...
            \begin{minipage}[c]{.432\linewidth}
                Todos los n\'umeros enteros se pueden formar sumando juegos de valor $1$ y $-1$. También podemos generar juegos de valores racionales; podemos utilizar los juegos de valor $0$ (gana el segundo jugador) para calcular valores de subjuegos, por ejemplo a la izquierda mostramos un subjuego que tiene valor $\frac{1}{2}$.
            \end{minipage}
        \end{minipage}
    }
