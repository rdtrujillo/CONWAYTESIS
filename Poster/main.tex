...
\begin{columns}
    \column{0.5}
    \block{\textit{``The Curious Mind of John Horton Conway''}}{
        ...
        \begin{minipage}[c]{\linewidth}
            \begin{minipage}[c]{0.70\linewidth}
                Este trabajo se concentra en sus aportes a la matem\'atica recreativa, mostramos c\'omo surgieron algunos conceptos, en particular estudiamos tres trabajos de Conway: el juego de la vida, la teor\'ia de juegos combinatorios, y los n\'umeros surreales. Los dos primeros los abordamos desde un punto de vista divulgativo. Finalmente explicamos c\'omo se obtienen los n\'umeros surreales a partir de los juegos. Adem\'as, definimos formalmente la estructura y las operaciones de los n\'umeros surreales para probar que es un cuerpo ordenado.

                Para la parte hist\'orica nos basamos fuertemente en su biograf\'ia, \textit{Genius at Play} \cite{Roberts2015-ur}.
            \end{minipage}
            \quad\quad\;
            \begin{minipage}[c]{0.20\linewidth}
                \includegraphics[width=\textwidth]{images/genius-at-play.jpg}
            \end{minipage}
        \end{minipage}
    ...
    \block{El juego de la vida}{
        Conway cuenta que fueron las ideas de c\'omo los aut\'omatas podr\'ian en alg\'un momento simular cosas complejas como el cerebro humano, o incluso, podr\'ian replicarse a s\'i mismas, las que dieron inicio a su inter\'es en crear aut\'omatas. Conway empez\'o a buscar aut\'omatas universales que tuvieran reglas simples. Fue inspirado en las ideas de Von Neumann, y en su aut\'omata universal, que se dedic\'o a estudiar aut\'omatas celulares de dos dimensiones.
        ...
        \innerblock{Reglas}{
            \begin{enumerate}
                ...
                \item \textbf{Regla de muerte:} Si una celda viva en el tiempo $t$ tiene estrictamente menos que $2$ vecinos vivos, la celda muere por soledad en el tiempo $t+1$. Si una celda viva en el tiempo $t$ tiene m\'as que $3$ vecinos vivos, la celda muere por hacinamiento en el tiempo $t+1$.
    ...
    \block{}{
        ...
        \begin{minipage}[c]{\linewidth}
            \begin{minipage}[c]{.5\linewidth}
                \centering
                \includegraphics[width=\textwidth]{images/hackenbush-half_proof.pdf}
            \end{minipage}
            \quad\quad
            \begin{minipage}[c]{.432\linewidth}
                Todos los n\'umeros enteros se pueden formar sumando juegos de valor $1$ y $-1$. También podemos generar juegos de valores racionales; podemos utilizar los juegos de valor $0$ (gana el segundo jugador) para calcular valores de subjuegos, por ejemplo a la izquierda mostramos una subjuego que tiene valor $\frac{1}{2}$.
            \end{minipage}
        \end{minipage}
    }
    ...
    \block{N\'umeros surreales}{
        ...
        \]
        esta clase es totalmente ordenada, adem\'as junto la suma definida, se puede definir una multiplicación para formar un cuerpo ordenado. A esta clase se le conoce como los n\'umeros surreales.
